...
namespace Charlatan
{
    public partial class MockNautilusForm : Form
    {
        ...
        public MockNautilusForm()
        {
            ...
            if (args.Length == 2) LoadAssembly(args[1]);
        }
        ...
        private void LoadAssembly(string path)
        {
            ...
            try
            {
                ...
                foreach (var extension in _extensionTypes)
                {
                    listExtensions.Items.Add(extension);
                }
            }
            catch (Exception ex)
            {
        ...
        private LSEXT.LSExtensionParameters SetupMockParameters()
        {
            ...
            parameters.Parameter = txtParameter.Text;
        ...
        private void DragDropAssembly(object sender, DragEventArgs e)
        {
        ...
        private void DragEnterAssembly(object sender, DragEventArgs e)
        {
